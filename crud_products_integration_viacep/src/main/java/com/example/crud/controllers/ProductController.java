...
import com.example.crud.service.SearchCEP;
...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProductRepository repository, AddressSearch addressSearch, SearchCEP searchCEP) {
    ...
    @GetMapping("/endpoint_cep")
    public ResponseEntity VerifyAvailability(@RequestParam String id, @RequestParam String cep){
        Optional<Product> optionalProduct = repository.findById(id);
        Product product = optionalProduct.get();
        Boolean availability = searchCEP.searchCEP(cep, product);
